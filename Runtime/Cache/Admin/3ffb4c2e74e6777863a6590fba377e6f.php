...
<div class="m-b-md">
    <h3 class="m-b-none">系统回复</h3>
</div>
<div class="row">
    <div class="col-sm-12">
        <section class="panel panel-default">
            <header class="panel-heading font-bold">系统回复</header>
            <div class="panel-body">
                <form role="form" action="" method="post">
                    <div class="form-group">
                        <label>关注时回复</label>
                        <input type="text" class="form-control" name="welcome" value="<?php echo ($field['welcome']); ?>">
                    </div>
                    <div class="form-group">
                        <label>默认回复</label>
                        <input type="text" class="form-control" name="default" value="<?php echo ($field['default']); ?>">
                    </div>
